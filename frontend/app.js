...
async function init() {
  ...
  if (elements.systemPrompt) {
    elements.systemPrompt.value = "Popraw gramatykę, interpunkcję i styl. Nadaj tekstowi profesjonalne, formalne brzmienie. Zachowaj oryginalną treść i strukturę.";
  }
